...
export const PutFormAdmin = ({ danhSachKhoaHoc }) => {
  ...
  useEffect(() => {
    if (danhSachKhoaHoc) {
      ...
      setValue(
        "maDanhMucKhoaHoc",
        danhSachKhoaHoc?.danhMucKhoaHoc?.maDanhMucKhoahoc
      );
            ...
            <Col span={12}>
              <Form.Item label="Bí danh">
                <Controller
                  ...
                  name="biDanh"
                  render={({ field }) => (
                    <Input {...field} type="text" placeholder="Bí Danh" />
                  )}
                ></Controller>
              </Form.Item>
            </Col>
            ...
            <Col span={12}>
              <Form.Item label="Lượt xem">
                <Controller
                  ...
                  name="luotXem"
                  render={({ field }) => (
                    <Input {...field} type="number" placeholder="luotXem" />
                  )}
                ></Controller>
              </Form.Item>
            </Col>
            <Col span={12}>
              <Form.Item label="Đánh giá">
                <Controller
                  ...
                  name="danhGia"
                  render={({ field }) => (
                    <Input {...field} type="number" placeholder="Đánh giá" />
                  )}
                ></Controller>
              </Form.Item>
            </Col>
            ...
            <Col span={12}>
              <Form.Item label="Tên khoá học">
                <Controller
                  ...
                  name="tenKhoaHoc"
                  render={({ field }) => (
                    <Input {...field} type="text" placeholder="Tên khoá học" />
                  )}
                ></Controller>
              </Form.Item>
            </Col>
